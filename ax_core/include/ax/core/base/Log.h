...
#define	ax_log_macro1( fmt ) 		ax_log_( ax_str(fmt) )
#define	ax_log_macro2( fmt, ... )	ax_log_( ax_str(fmt), __VA_ARGS__ )
#define	ax_log_macro3( fmt, ... )	ax_log_( ax_str(fmt), __VA_ARGS__ )
#define	ax_log_macro4( fmt, ... )	ax_log_( ax_str(fmt), __VA_ARGS__ )
#define	ax_log_macro5( fmt, ... )	ax_log_( ax_str(fmt), __VA_ARGS__ )
#define	ax_log_macro6( fmt, ... )	ax_log_( ax_str(fmt), __VA_ARGS__ )
#define	ax_log_macro7( fmt, ... )	ax_log_( ax_str(fmt), __VA_ARGS__ )
#define	ax_log_macro8( fmt, ... )	ax_log_( ax_str(fmt), __VA_ARGS__ )
#define	ax_log_macro9( fmt, ... )	ax_log_( ax_str(fmt), __VA_ARGS__ )
...
#define	ax_dump_macro1( a0 )					{ ax_log( "{?}={?}\t\t[#{?}:{?}]", 												ax_str(#a0),(a0), 																							ax__FILE_BASENAME__, ax__LINE__ ); }
#define	ax_dump_macro2( a0,a1 )					{ ax_log( "{?}={?}, {?}={?}\t\t[#{?}:{?}]", 									ax_str(#a0),(a0), ax_str(#a1),(a1), 																		ax__FILE_BASENAME__, ax__LINE__ ); }
#define	ax_dump_macro3( a0,a1,a2 )				{ ax_log( "{?}={?}, {?}={?}, {?}={?}\t\t[#{?}:{?}]", 							ax_str(#a0),(a0), ax_str(#a1),(a1), ax_str(#a2),(a2), 														ax__FILE_BASENAME__, ax__LINE__ ); }
#define	ax_dump_macro4( a0,a1,a2,a3 )			{ ax_log( "{?}={?}, {?}={?}, {?}={?}, {?}={?}\t\t[#{?}:{?}]",					ax_str(#a0),(a0), ax_str(#a1),(a1), ax_str(#a2),(a2), ax_str(#a3),(a3), 									ax__FILE_BASENAME__, ax__LINE__ ); }
#define	ax_dump_macro5( a0,a1,a2,a3,a4 )		{ ax_log( "{?}={?}, {?}={?}, {?}={?}, {?}={?}, {?}={?}\t\t[#{?}:{?}]", 			ax_str(#a0),(a0), ax_str(#a1),(a1), ax_str(#a2),(a2), ax_str(#a3),(a3), ax_str(#a4),(a4), 					ax__FILE_BASENAME__, ax__LINE__ ); }
#define	ax_dump_macro6( a0,a1,a2,a3,a4,a5 )		{ ax_log( "{?}={?}, {?}={?}, {?}={?}, {?}={?}, {?}={?}, {?}={?}\t\t[#{?}:{?}]",	ax_str(#a0),(a0), ax_str(#a1),(a1), ax_str(#a2),(a2), ax_str(#a3),(a3), ax_str(#a4),(a4), ax_str(#a5),(a5), ax__FILE_BASENAME__, ax__LINE__ ); }
...
//		std::cout <<  msg.c_str() << "\n";
	...
	template< typename T > inline
	static void 	Log( const StringBuilderX<T> & msg ) {
//		std::cout <<  msg.c_str() << "\n";
